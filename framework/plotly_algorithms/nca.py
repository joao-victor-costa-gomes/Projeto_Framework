...
class NCA:
    def __init__(self, nome=None, base_dados=None, amostragem=None, nca1=None, nca2=None, dimensao=None):

        self.__verificar_extensao_csv(base_dados)
        self.__verificar_parametros(nome, base_dados, amostragem, nca1, nca2)
    ...
    def __verificar_parametros(self, nome, base_dados, amostragem, nca1, nca2):
        if nome == None:
        ...
        if nca1 == None:
             raise ValueError('Faltou informar o parâmetro "nca1"')
        if nca2 == None:
             raise ValueError('Faltou informar o parâmetro "nca2"')



if __name__ == "__main__":

    mobile_price_range = NCA(
    "NCA-PriceRange-2D",    
    "mobile_devices.csv", 
    1.0,
